...
from .lib_convcode import conv_encode
...
def turbo_encode(msg_bits, trellis1, trellis2, interleaver):
    ...
    stream_2 = conv_encode(interlv_msg_bits, trellis2, 'rsc', puncture_matrix)
    # 冗長なためこちらは無視
    # sys_stream_2 = stream_2[::3]
    e1_bar = stream_2[1::3]
    e2_bar = stream_2[2::3]
    ...
    non_sys_stream_2 = concatenate(
        [e1_bar[0:-trellis2.total_memory], e2_bar[0:-trellis2.total_memory]]
        )
